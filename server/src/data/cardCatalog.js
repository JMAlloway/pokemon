...
const CARD_CATALOG = [
...

  {
    ...
    cards: [
      ...
      { name: 'Lotad', number: '004', rarity: 'common' },
      { name: 'Lombre', number: '005', rarity: 'common' },
      { name: 'Nymble', number: '008', rarity: 'common' },
      { name: 'Charmander', number: '011', rarity: 'common' },
      { name: 'Charmeleon', number: '012', rarity: 'common' },
      { name: 'Darumaka', number: '014', rarity: 'common' },
      { name: 'Charcadet', number: '017', rarity: 'common' },
      { name: 'Seel', number: '019', rarity: 'common' },
      { name: 'Swinub', number: '021', rarity: 'common' },
      { name: 'Piloswine', number: '022', rarity: 'common' },
      { name: 'Piplup', number: '024', rarity: 'common' },
      { name: 'Yamper', number: '028', rarity: 'common' },
      { name: 'Pawmi', number: '030', rarity: 'common' },
      { name: 'Pawmo', number: '031', rarity: 'common' },
      { name: 'Misdreavus', number: '033', rarity: 'common' },
      { name: 'Snubbull', number: '035', rarity: 'common' },
      { name: 'Milcery', number: '038', rarity: 'common' },
      { name: 'Bramblin', number: '041', rarity: 'common' },
      { name: 'Tauros', number: '043', rarity: 'common' },
      { name: 'Gligar', number: '044', rarity: 'common' },
      { name: 'Trapinch', number: '046', rarity: 'common' },
      { name: 'Gastly', number: '048', rarity: 'common' },
      { name: 'Haunter', number: '049', rarity: 'common' },
      { name: 'Murkrow', number: '051', rarity: 'common' },
      { name: 'Carvanha', number: '053', rarity: 'common' },
      { name: 'Wooper', number: '055', rarity: 'common' },
      { name: 'Sandile', number: '057', rarity: 'common' },
      { name: 'Toxel', number: '059', rarity: 'common' },
      { name: 'Bronzor', number: '060', rarity: 'common' },
      { name: 'Jigglypuff', number: '063', rarity: 'common' },
      { name: 'Meowth', number: '065', rarity: 'common' },
      { name: 'Zigzagoon', number: '067', rarity: 'common' },
      { name: 'Starly', number: '069', rarity: 'common' },
      // Uncommon
      { name: 'Vileplume', number: '003', rarity: 'uncommon' },
      { name: 'Ludicolo', number: '006', rarity: 'uncommon' },
      { name: 'Lokix', number: '009', rarity: 'uncommon' },
      { name: 'Darmanitan', number: '015', rarity: 'uncommon' },
      { name: 'Ceruledge', number: '018', rarity: 'uncommon' },
      { name: 'Dewgong', number: '020', rarity: 'uncommon' },
      { name: 'Mamoswine', number: '023', rarity: 'uncommon' },
      { name: 'Prinplup', number: '025', rarity: 'uncommon' },
      { name: 'Boltund', number: '029', rarity: 'uncommon' },
      { name: 'Pawmot', number: '032', rarity: 'uncommon' },
      { name: 'Mismagius', number: '034', rarity: 'uncommon' },
      { name: 'Granbull', number: '036', rarity: 'uncommon' },
      { name: 'Alcremie', number: '039', rarity: 'uncommon' },
      { name: 'Brambleghast', number: '042', rarity: 'uncommon' },
      { name: 'Gliscor', number: '045', rarity: 'uncommon' },
      { name: 'Vibrava', number: '047', rarity: 'uncommon' },
      { name: 'Honchkrow', number: '052', rarity: 'uncommon' },
      { name: 'Clodsire', number: '056', rarity: 'uncommon' },
      { name: 'Krookodile', number: '058', rarity: 'uncommon' },
      { name: 'Bronzong', number: '061', rarity: 'uncommon' },
      { name: 'Wigglytuff', number: '064', rarity: 'uncommon' },
      { name: 'Ambipom', number: '066', rarity: 'uncommon' },
      { name: 'Linoone', number: '068', rarity: 'uncommon' },
      { name: 'Lopunny', number: '070', rarity: 'uncommon' },
      // Rare
      { name: 'Genesect', number: '007', rarity: 'rare' },
      { name: 'Charizard', number: '013', rarity: 'rare' },
      { name: 'Oricorio', number: '016', rarity: 'rare' },
      { name: 'Rotom', number: '027', rarity: 'rare' },
      { name: 'Gengar', number: '050', rarity: 'rare' },
      { name: 'Seviper', number: '054', rarity: 'rare' },
      { name: 'Togedemaru', number: '062', rarity: 'rare' },
      { name: 'Archaludon', number: '071', rarity: 'rare' },
      // Ultra Rare
      { name: 'Empoleon ex', number: '026', rarity: 'ultraRare' },
      { name: 'Meloetta ex', number: '037', rarity: 'ultraRare' },
      { name: 'Diancie ex', number: '040', rarity: 'ultraRare' },
      { name: 'Flygon ex', number: '072', rarity: 'ultraRare' },
      { name: 'Zacian ex', number: '073', rarity: 'ultraRare' },
      { name: 'Duraludon ex', number: '074', rarity: 'ultraRare' },
      // Illustration Rare
      { name: 'Charizard', number: '082', rarity: 'illustrationRare' },
      { name: 'Gengar', number: '083', rarity: 'illustrationRare' },
      { name: 'Empoleon ex', number: '084', rarity: 'illustrationRare' },
      { name: 'Zacian ex', number: '085', rarity: 'illustrationRare' },
      { name: 'Flygon ex', number: '086', rarity: 'illustrationRare' },
      // Special Illustration Rare
      { name: 'Charizard', number: '090', rarity: 'specialIllustrationRare' },
      { name: 'Gengar', number: '091', rarity: 'specialIllustrationRare' },
      { name: 'Zacian ex', number: '092', rarity: 'specialIllustrationRare' },
      { name: 'Empoleon ex', number: '093', rarity: 'specialIllustrationRare' },
      // Trainers
      { name: 'Battle Cage', number: '075', rarity: 'uncommon' },
      { name: 'Dawn', number: '076', rarity: 'uncommon' },
      { name: "Grimsley's Move", number: '077', rarity: 'uncommon' },
      { name: 'Firebreather', number: '078', rarity: 'uncommon' },
      { name: 'Dawn', number: '088', rarity: 'illustrationRare' },
      { name: 'Firebreather', number: '089', rarity: 'illustrationRare' },
    ]
  },
